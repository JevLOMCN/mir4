...
#include "MM_Popup_Addressbook_Slot.generated.h"
...
class UMM_Popup_Addressbook_Slot : public UWidgetBase, public IUserObjectListEntry {
    GENERATED_BODY()
public:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    int32 STRING_ONLINE_ID;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    int32 STRING_OFFLINE_ID;
...
private:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Instanced, Transient, meta=(AllowPrivateAccess=true))
    UMirTextBlock* m_Txt_UserState;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Instanced, Transient, meta=(AllowPrivateAccess=true))
    UMM_Common_Btn* m_C_Btn_Select;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Instanced, Transient, meta=(AllowPrivateAccess=true))
    UMirCheckBox* m_CheckBox_Select;
    
public:
    UMM_Popup_Addressbook_Slot();

    UFUNCTION(BlueprintCallable)
    void OnClickSelect();
    
    UFUNCTION(BlueprintCallable)
    void OnClickCheckBoxSelect(bool bChecked);

...
#include "MM_Slot_Collect_Item.generated.h"
...
class UMM_Slot_Collect_Item : public UWidgetBase, public IUserObjectListEntry {
    GENERATED_BODY()
public:

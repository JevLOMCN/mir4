...
#include "MM_B_Guild_MarkChange.generated.h"

class UEditableText;
class UImage;
class UMM_Common_Btn_Cost;
class UMM_Common_Btn_Symbol;
class UMM_GuildIconSlot;
class UScrollBox;
class UTextBlock;
class UWidgetAnimation;

UCLASS(Blueprintable, EditInlineNew)
class UMM_B_Guild_MarkChange : public UWidgetBase {
    GENERATED_BODY()
public:
...
private:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Instanced, Transient, meta=(AllowPrivateAccess=true))
    TArray<UMM_GuildIconSlot*> m_arSymbolList;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Instanced, Transient, meta=(AllowPrivateAccess=true))
    TArray<UMM_GuildIconSlot*> m_arFrameList;
